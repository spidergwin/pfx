        ...
        <div className="rounded-2xl bg-white p-8 border border-slate-200 shadow-sm space-y-7">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><strong>Student Communications</strong> — order details and questions submitted during direct enrollment.</li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>To provide direct student onboarding and course verification.</li>
          ...
          <section className="space-y-2">
            ...
            <p>If you have any questions about this Privacy Policy, reach out to our official student support team via the academy communication channels.</p>
          </section>
        </div>
      </main>

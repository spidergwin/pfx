...
export const PFX_COURSE: CourseData = {
  id: "pfx-masterclass-30-days",
  slug: "prince-of-forex-masterclass",
  title: "Prince of Forex Masterclass in 30 Days for Beginners",
  subtitle: "Master Price Action, Institutional Risk Management & Profitability",
  description:
    "This Specialization is an introduction to mastering the global foreign exchange market. Learn price action, risk management, market structure, candlestick patterns, and trade execution strategies directly from Prince of Forex (PFX). The course will be delivered directly to your email upon purchase.",
  price: 40.0,
  originalPrice: 60.0,
  rating: 4.8,
  enrolledCount: 5458,
  ...
  chapters: [
    ...
    },
    {
      ...
      lessons: [
        ...
        { title: "Using the PFX Lot Size Calculator", durationMins: 25, isFreePreview: false },
    ...
    },
    {
      ...
      lessons: [
        { title: "The Prince of Forex Core Entry Setup", durationMins: 45, isFreePreview: false },
...
export const PFX_REVIEWS = [
  {
    ...
    comment: "The PFX Masterclass completely changed how I view market structure. The risk management module alone saved my trading account!",
    rating: 5,
  },
  {
    name: "Sarah Jenkins",
...
export const FAQ_ITEMS = [
  {
    q: "Who is Prince of Forex (PFX)?",
    a: "Prince of Forex (PFX) is a professional trader and educator dedicated to helping students achieve long-term market profitability through disciplined risk management and price action logic.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes! Once purchased, you get unlimited lifetime access to all 30 chapters, video lessons, quizzes, and future updates.",
  },
  {
    q: "How will the course be delivered?",
    a: "The course will be delivered directly to your email address immediately upon purchase completion.",
  },
  {
    q: "How do I access the PFX Lot Size Calculator?",
    a: "The PFX Lot Size Calculator is accessible directly from the navigation bar on our website. It is a free tool to calculate exact standard, mini, and micro lot sizes.",
  },
];

export const BLOG_POSTS = [
  {
    slug: "prince-of-forex-price-action-guide",
    title: "Mastering Price Action: The Prince of Forex Core Framework",
    excerpt: "Learn how to identify high-confluence support and resistance zones without relying on lagging indicators.",
    date: "August 14, 2026",
    author: "Prince of Forex Team",
  },
  {

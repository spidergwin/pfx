...
export const PFX_REVIEWS = [
  ...
  },
  {
    ...
    comment: "Clear, concise, and straight to the point. No fluff or lagging indicators, just pure institutional price action logic.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    ...
    country: "Singapore",
    comment: "The Lot Size Calculator and 1% risk rules are indispensable. Best course investment I have made in my trading career.",
    rating: 5,
  },
  {
    name: "David Adeleke",
    role: "Funded Trader",
    country: "Nigeria",
    comment: "Passed my $50k prop firm challenge within 3 weeks of applying the NFI market structure and entry timing framework!",
    rating: 5,
  },
  {
    name: "Elena Rostova",
    role: "Swing Trader",
    country: "Germany",
    comment: "Understanding candlestick rejection wicks and key support/resistance zones gave me complete confidence in my execution.",
    rating: 5,
  },
  {
    ...
    role: "Verified Student",
    country: "Canada",
    comment: "Worth 10x the price. The 30 chapters are structured in a logical progression that any beginner can follow without feeling overwhelmed.",
    rating: 5,
  },
  {
    ...
    role: "Day Trader",
    country: "UAE",
    comment: "Instant access upon WhatsApp confirmation was seamless. Direct mentor support is top notch.",
    rating: 5,
  },
  {
    ...
    role: "Verified Student",
    country: "Nigeria",
    comment: "The psychology section broke my bad habit of over-leveraging and revenge trading. Truly transformative program.",
    rating: 5,
  },
  {
    name: "Liam O'Connor",
    ...
    country: "Ireland",
    comment: "Super practical and actionable. You learn how to identify high-probability setups step by step.",
    rating: 5,
  },
  {
    ...
    role: "Verified Student",
    country: "Spain",
    comment: "10 hours of pure value without unnecessary jargon. The quizzes after each chapter really solidify your knowledge.",
    rating: 5,
  },
];
